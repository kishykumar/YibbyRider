...
public protocol CardFieldsViewDelegate {
     ...
     */
    func cardTextField(_ cardFieldsView: CardFieldsView, didEnterCardInformation information: Card, withValidationResult validationResult: CardValidationResult)
     ...
     */
    func cardTextFieldShouldShowAccessoryImage(_ cardFieldsView: CardFieldsView) -> UIImage?
     ...
     */
    func cardTextFieldShouldProvideAccessoryAction(_ cardFieldsView: CardFieldsView) -> (() -> ())?
     ...
     */
    func cardTextFieldShouldProvideAccessoryButtonAccessibilityLabel(_ cardFieldsView: CardFieldsView) -> String?
}
