...
public protocol CardFieldsViewDelegate {
     ...
     */
    func cardTextField(cardFieldsView: CardFieldsView, didEnterCardInformation information: Card, withValidationResult validationResult: CardValidationResult)
     ...
     */
//    func cardTextFieldShouldShowAccessoryImage(cardFieldsView: CardFieldsView) -> UIImage?
     ...
     */
//    func cardTextFieldShouldProvideAccessoryAction(cardFieldsView: CardFieldsView) -> (() -> ())?
     ...
     */
//    func cardTextFieldShouldProvideAccessoryButtonAccessibilityLabel(cardFieldsView: CardFieldsView) -> String?
}
